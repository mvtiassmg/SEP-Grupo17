...
XTmrCtr TimerInstance;          // Definición única
volatile int flag_read_opt = 0; // Definición única
...
int timer_init_1s(void)
{
    ...
    /* Registrar el callback de alto nivel */
    ...
    /* Cargar el valor para 1 s: TIMER_CLOCK_FREQ cuentas (50 MHz) */
