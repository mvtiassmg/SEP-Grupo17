...
architecture STRUCTURE of design_1 is
  ...
  component design_1_wave_gen_0_1 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
  ...
  end component design_1_wave_gen_0_1;
  ...
  attribute X_INTERFACE_PARAMETER of sys_clk : signal is "XIL_INTERFACENAME CLK.SYS_CLK, CLK_DOMAIN design_1_clk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
begin
  reset_0_1 <= rst;
  sys_clk_1 <= sys_clk;
...
vio_0: component design_1_vio_0_0
     port map (
      clk => clk_wiz_0_clk_out1,
      probe_in0(7 downto 0) => wave_gen_0_sin(7 downto 0),
      probe_in1(7 downto 0) => wave_gen_0_cos(7 downto 0),
      probe_in2(7 downto 0) => wave_gen_0_triang(7 downto 0),
      probe_out0(0) => vio_0_probe_out0(0)
    );
wave_gen_0: component design_1_wave_gen_0_1
     port map (
      clk => clk_wiz_0_clk_out1,
