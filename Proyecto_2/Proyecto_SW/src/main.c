...
/* ---- Direcciones de registros de GPIO----*/
...
/* ---- Funciones de lectura de botones, switches y enable ---- */
...
/* ----Funciones de escritura leds y RGB ---- */
...
{   /* Direcciones (TRI: 1=entrada, 0=salida) */
    ...
    // almacena el patrón de LED actual que el jugador debe presionar
