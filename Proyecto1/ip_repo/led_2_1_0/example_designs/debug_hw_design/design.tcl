...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: led_2_0, and set properties
	set led_2_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:led_2:1.0 led_2_0 ]
	...
	# Connect all clock & reset of led_2_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins led_2_0/led_master]
	connect_bd_net [get_bd_pins led_2_0/led_master_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins led_2_0/led_master_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to led_2_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/led_2_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_led_2_0_led_master_* ]]
	puts $fp "set led_master_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:led_2:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/led_2_hw_test.tcl
