...
architecture STRUCTURE of GuitarSep_MemorySequency_0_0_MemorySequency is
  ...
  signal \freq_reg[3]_i_14_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \counter_clk[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \counter_clk[10]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \counter_clk[11]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \counter_clk[12]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \counter_clk[13]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \counter_clk[14]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \counter_clk[15]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \counter_clk[16]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \counter_clk[17]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \counter_clk[18]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \counter_clk[19]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \counter_clk[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \counter_clk[20]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \counter_clk[21]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \counter_clk[22]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \counter_clk[23]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \counter_clk[24]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \counter_clk[25]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \counter_clk[26]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \counter_clk[27]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \counter_clk[28]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \counter_clk[29]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \counter_clk[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \counter_clk[30]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \counter_clk[31]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \counter_clk[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \counter_clk[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \counter_clk[5]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \counter_clk[6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \counter_clk[7]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \counter_clk[8]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \counter_clk[9]_i_1\ : label is "soft_lutpair5";
...
\counter_clk[31]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\freq_reg[3]_i_12\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\freq_reg[3]_i_13\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\freq_reg[3]_i_14\: unisim.vcomponents.LUT6
    generic map(
...
\freq_reg[3]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \freq_reg[3]_i_11_n_0\,
      I3 => \freq_reg[3]_i_12_n_0\,
      I4 => \freq_reg[3]_i_13_n_0\,
      I5 => \freq_reg[3]_i_14_n_0\,
...
\freq_reg[3]_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\freq_reg_reg[3]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \freq_reg[3]_i_5_n_0\,
      S(2) => \freq_reg[3]_i_6_n_0\,
      S(1) => \freq_reg[3]_i_7_n_0\,
      S(0) => \freq_reg[3]_i_8_n_0\
    );
