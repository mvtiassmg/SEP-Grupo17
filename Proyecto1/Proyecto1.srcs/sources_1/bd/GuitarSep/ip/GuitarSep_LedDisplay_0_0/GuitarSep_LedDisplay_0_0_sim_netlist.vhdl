...
--               Programables/SEP-Grupo17/Proyecto1/Proyecto1.srcs/sources_1/bd/GuitarSep/ip/GuitarSep_LedDisplay_0_0/GuitarSep_LedDisplay_0_0_sim_netlist.vhdl}
...
entity GuitarSep_LedDisplay_0_0_ScoreCounter is
  port (
    nail : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of GuitarSep_LedDisplay_0_0_ScoreCounter : entity is "ScoreCounter";
end GuitarSep_LedDisplay_0_0_ScoreCounter;

architecture STRUCTURE of GuitarSep_LedDisplay_0_0_ScoreCounter is
  ...
  attribute SOFT_HLUTNM of \led[1]_INST_0\ : label is "soft_lutpair4";
...
\score_reg[3]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"559A5A9A"
    )
        port map (
...
\score_reg[3]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\score_reg[3]_i_7\: unisim.vcomponents.LUT6
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GuitarSep_LedDisplay_0_0_leds_game is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of GuitarSep_LedDisplay_0_0_leds_game : entity is "leds_game";
end GuitarSep_LedDisplay_0_0_leds_game;

architecture STRUCTURE of GuitarSep_LedDisplay_0_0_leds_game is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GuitarSep_LedDisplay_0_0_miss_counter is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of GuitarSep_LedDisplay_0_0_miss_counter : entity is "miss_counter";
end GuitarSep_LedDisplay_0_0_miss_counter;

architecture STRUCTURE of GuitarSep_LedDisplay_0_0_miss_counter is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GuitarSep_LedDisplay_0_0_LedDisplay is
  port (
    led6_r : out STD_LOGIC;
    led6_g : out STD_LOGIC;
    led : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of GuitarSep_LedDisplay_0_0_LedDisplay : entity is "LedDisplay";
end GuitarSep_LedDisplay_0_0_LedDisplay;

architecture STRUCTURE of GuitarSep_LedDisplay_0_0_LedDisplay is
  signal nail : STD_LOGIC;
  signal score_counter_n_1 : STD_LOGIC;
  signal stopped : STD_LOGIC;
begin
leds: entity work.GuitarSep_LedDisplay_0_0_leds_game
     port map (
      led6_g => led6_g,
      led6_r => led6_r,
      nail => nail,
...
missed_counter: entity work.GuitarSep_LedDisplay_0_0_miss_counter
     port map (
      clk => clk,
      reset => reset,
...
score_counter: entity work.GuitarSep_LedDisplay_0_0_ScoreCounter
     port map (
...
entity GuitarSep_LedDisplay_0_0 is
  ...
  attribute NotValidForBitStream of GuitarSep_LedDisplay_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of GuitarSep_LedDisplay_0_0 : entity is "GuitarSep_LedDisplay_0_0,LedDisplay,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of GuitarSep_LedDisplay_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of GuitarSep_LedDisplay_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of GuitarSep_LedDisplay_0_0 : entity is "LedDisplay,Vivado 2020.1";
end GuitarSep_LedDisplay_0_0;

architecture STRUCTURE of GuitarSep_LedDisplay_0_0 is
...
U0: entity work.GuitarSep_LedDisplay_0_0_LedDisplay
     port map (
      btn_push(3 downto 0) => btn_push(3 downto 0),
      clk => clk,
      led(3 downto 0) => led(3 downto 0),
