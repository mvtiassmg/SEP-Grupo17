...
HD_PWD='C:/Users/tomas/escritorio/Universidad/SEP/Proyecto/SEP-Grupo17/Proyecto1/Proyecto1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GuitarSep_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GuitarSep_wrapper.tcl
